...
[^image-net-historical]: |
    [A Roadmap for Foundational Research on Artificial Intelligence in Medical Imaging From the 2018 NIHRSNAACR](https://www.researchgate.net/publication/332452649_A_Roadmap_for_Foundational_Research_on_Artificial_Intelligence_in_Medical_Imaging_From_the_2018_NIHRSNAACRThe_Academy_Workshop)
...
console.log(alcf_rand.shape)
alcf_rand = alcf_rand.reshape(alcf_rand.shape[1:])

console.log(alcf_tensor.shape)
...
#             console.log(f"Epoch {j}: training loss: {loss:.3f}, accuracy: {acc:.3f}")
#
#     with tqdm(total=len(val_dataloader), position=0, leave=True, desc=f"Validate Epoch {j}") as val_bar:
#         acc_val, loss_val = evaluate(val_dataloader, model, loss_fn, val_bar)
#         console.log(f"Epoch {j}: validation loss: {loss_val:.3f}, accuracy: {acc_val:.3f}")
```
