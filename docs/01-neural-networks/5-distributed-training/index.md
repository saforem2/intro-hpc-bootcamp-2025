...
- [🌐 Training on Multiple
  ...
  - [👬 Distributed Data Parallelism:
    DDP](#two_men_holding_hands-distributed-data-parallelism-ddp)
  - [DDP: Forward Pass](#ddp-forward-pass)
  - [DDP: Backward Pass](#ddp-backward-pass)
  - [DDP: Full Setup](#ddp-full-setup)
